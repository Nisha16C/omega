...
const compat_momoa_1 = require("./compat-momoa");
function createRule(ruleName, rule) {
    return {
        ...
        create(context) {
            var _a;
            const create = (0, compat_momoa_1.compatMomoaCreate)(rule.create);
            ...
            if (typeof ((_a = sourceCode.parserServices) === null || _a === void 0 ? void 0 : _a.defineCustomBlocksVisitor) ===
                "function" &&
                path_1.default.extname((0, eslint_compat_utils_1.getFilename)(context)) === ".vue") {
