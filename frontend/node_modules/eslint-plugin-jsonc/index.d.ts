...
declare module 'eslint-plugin-jsonc' {
    ...
    import { compatMomoaCreate } from "eslint-plugin-jsonc/utils/compat-momoa";
    ...
    export { meta, configs, rules, compatMomoaCreate, AST, parseForESLint, parseJSON, traverseNodes, getStaticJSONValue, };
}
...
declare module 'eslint-plugin-jsonc/utils/compat-momoa' {
    import type { Rule } from "eslint";
    export function compatMomoaCreate<R extends object, F extends (context: Rule.RuleContext, ...args: any[]) => R>(create: F): F;
}
