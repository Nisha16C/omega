...
function getIframeSrc(isDark) {
  const baseSrc = `https://10.0.34.155:3000/d/ednr88j8zffnkf/edr-summary?from=2024-11-26T03:49:31.497Z&to=2024-11-26T09:49:31.498Z&var-Filters=&var-agent_name=$__all&var-rule_level=3&theme=light`;
